            ...
            <ul>
              ...
              <li class="mb-4">
                <label for="on_sale" class="flex items-center dark:text-gray-300">
                  <input type="checkbox" wire:model.live="on_sale" id="on_sale" value="on_sale" class="w-4 h-4 mr-2">
          ...
          <div class="p-4 mb-5 bg-white border border-gray-200 dark:border-gray-900 dark:bg-gray-900">
            ...
            <div>
              ...
              <div class="font-semibold mb-2">
                {{ Number::currency($min_price) }} - {{ Number::currency($max_price) }}
              </div>

              <!-- slider min -->
              <label class="block text-sm text-gray-500 dark:text-gray-400">Min</label>
              <input type="range" wire:model.lazy="min_price" class="w-full h-1 mb-4 bg-blue-100 rounded cursor-pointer"
                min="1000" max="500000" step="1000">

              <!-- slider max -->
              <label class="block text-sm text-gray-500 dark:text-gray-400">Max</label>
              <input type="range" wire:model.lazy="max_price" class="w-full h-1 mb-4 bg-blue-100 rounded cursor-pointer"
                min="1000" max="500000" step="1000">

              {{-- <!-- debug (buat ngeliat dia bisa jalan apa gak) -->
              <div class="mt-2 text-sm text-red-500">
                Debug Livewire: min={{ $min_price }} | max={{ $max_price }}
              </div> --}}
              ...
              <div class="border border-gray-300 dark:border-gray-700">
                <div class="relative bg-gray-200">
                  <a href="/products/{{ $product->slug }}" class="">
                    <img src="{{ url('storage', $product->image) }}" alt="" class="{{ $product->name }} ">
                  </a>
                </div>
                <div class="p-3 ">
